...
$config = array(
	...
	*/
	...
	|
	*/
	'upload_dir' => '/passerelle/uploads/'. $_SESSION['id_optimizme_user'] .'/',
	/*
	|--------------------------------------------------------------------------
	...
	|
	*/
	'current_path' => '../uploads/'. $_SESSION['id_optimizme_user'] .'/',
	...
	|
	*/
	'thumbs_base_path' => '../thumbs/'. $_SESSION['id_optimizme_user'] .'/',
	...
	*/
	...
	'ext_img'                                 => array( 'jpg', 'jpeg', 'png', 'gif', 'bmp', 'tiff', 'svg' ), //Images
	'ext_file'                                => array( 'doc', 'docx', 'rtf', 'pdf', 'xls', 'xlsx', 'ppt', 'pptx', 'odt', 'ots', 'ott', 'odb', 'odg', 'otp', 'otg', 'odf', 'ods', 'odp' ), //Files
