...
var boolGenerateImage = 1;      // bool : génération ou non d'images pour le debug
...
var steps = [
    function() {
        ...
        */
        ...
        page.open(urlAccesBackoffice, function (status) {
    ...
    function() {
        ...
        if (boolFinish == 0){
            ...
            boolFinish = page.evaluate(function(formLogin, formPassword) {
                if (document.getElementById("weebly-username") && document.getElementById("weebly-password")){
                    document.getElementById("weebly-username").value = formLogin;
                    document.getElementById("weebly-password").value = formPassword;
                    return 0;
                }
                else {
    ...
    function() {
        ...
        fs.write('3.html', page.content, 'w');

        boolFinish = page.evaluate(function() {
            if (document.getElementById("weebly-login")){
                document.getElementById("weebly-login").submit();
    ...
    function(){
        ...
        fs.write('4.html', page.content, 'w');
